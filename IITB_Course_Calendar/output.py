...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(908, 608)
        self.centralWidget = QtWidgets.QWidget(MainWindow)
        self.centralWidget.setObjectName("centralWidget")
        self.tableWidget = QtWidgets.QTableWidget(self.centralWidget)
        self.tableWidget.setGeometry(QtCore.QRect(10, 10, 891, 261))
        ...
        self.gridLayoutWidget_3.setGeometry(QtCore.QRect(380, 280, 521, 301))
        ...
        self.gridLayoutWidget_4.setGeometry(QtCore.QRect(10, 370, 361, 201))
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 280, 361, 91))
    ...
    def logout(self):
        ...
        if not os.path.exists(credential_dir):
            self.error_dialog = QtWidgets.QMessageBox()
            self.error_dialog.setIcon(QtWidgets.QMessageBox.Error)
            self.error_dialog.setText('Not Logged In')
            self.error_dialog.setWindowTitle('Error')
            self.error_dialog.setStandardButtons(QtWidgets.QMessageBox.Close)
            self.error_dialog.exec_()
        else:
            os.removedirs(credential_dir)
            self.error_dialog = QtWidgets.QMessageBox()
            self.error_dialog.setIcon(QtWidgets.QMessageBox.Information)
